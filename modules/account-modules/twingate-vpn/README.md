...
| [http_http.twingate_connector_tag](https://registry.terraform.io/providers/hashicorp/http/latest/docs/data-sources/http) | data source |
...
| <a name="input_connector_track"></a> [connector\_track](#input\_connector\_track) | twingate/connector tag to follow (a major track). Resolved to its current digest on every plan. | `string` | `"1"` | no |
