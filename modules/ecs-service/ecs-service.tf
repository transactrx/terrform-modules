...
resource "aws_lb_target_group" "nlbTargetGroup" {
  ...
  target_type          = "ip"
  name                 = var.networkLoadBalancerAttachments[count.index].name=="" ?"${var.serviceName}${var.networkLoadBalancerAttachments[count.index].name}":"${var.serviceName}-${var.networkLoadBalancerAttachments[count.index].containerName}-${var.networkLoadBalancerAttachments[count.index].containerPort}"
